define("taoDevTools/controller/ControllerMap/index",function(){}),define("taoDevTools/controller/fontConversion/fileUpload",["jquery","uikitLoader","ui/uploader","ui/feedback"],function($,ui,uploader,feedback){var container=$("#upload-container");container.uploader({uploadUrl:container.data("url")}),container.on("upload.uploader",function(e,file,interactionHook){feedback().success(interactionHook.success)}),container.on("fail.uploader",function(e,file,interactionHook){feedback().error(interactionHook.message)})}),define("json!taoDevTools/controller/KeyChecker/shortcuts.json",function(){return[{label:"<Meta>+C",shortcut:"Meta+C",platform:"mac",browser:"all",
description:"Copy to clipboard.",playground:!0},{label:"<Meta>+V",shortcut:"Meta+V",platform:"mac",browser:"all",description:"Paste from clipboard.",playground:!0},{label:"<Meta>+<Alt>+V",shortcut:"Meta+Alt+V",platform:"mac",browser:"all",description:"Paste Style",playground:!0},{label:"<Meta>+<Shift>+<Alt>+V",shortcut:"Meta+Shift+Alt+V",platform:"mac",browser:"all",description:"Paste and Match Style",playground:!0},{label:"<Meta>+X",shortcut:"Meta+X",platform:"mac",browser:"all",description:"Cut to the clipboard",playground:!0},{label:"<Meta>+:",shortcut:"Meta+:",platform:"mac",browser:"all",description:"Show / Hide Spelling and Grammar",playground:!1},{
label:"<Ctrl>+F3",shortcut:"Ctrl+F3",platform:"mac",browser:"all",description:"Opens windows menu / dock.",playground:!1},{label:"<Ctrl>+F2",shortcut:"Ctrl+F2",platform:"mac",browser:"all",description:"Activate Menu",playground:!1},{label:"<Ctrl>+F8",shortcut:"Ctrl+F8",platform:"mac",browser:"all",description:"Active Menu Extras",playground:!1},{label:"<Shift>+<Meta>+Right",shortcut:"Shift+Meta+Right",platform:"mac",browser:"all",description:"Switch Applications",playground:!1},{label:"<Meta>+<Alt>+W",shortcut:"Meta+Alt+W",platform:"mac",browser:"all",description:"Close application",playground:!1},{label:"<Meta>+<Shift>+3",shortcut:"Meta+Shift+3",
platform:"mac",browser:"all",description:"Take screenshot (entire screen)",playground:!1},{label:"<Meta>+<Shift>+4",shortcut:"Meta+Shift+4",platform:"mac",browser:"all",description:"Take screenshot (partial / active window)",playground:!1},{label:"<Meta>+<Shift>+W",shortcut:"Meta+Shift+W",platform:"mac",browser:"all",description:"Closes the current window.",playground:!1},{label:"<Meta>+M",shortcut:"Meta+M",platform:"mac",browser:"all",description:"Minimizes the window.",playground:!1},{label:"<Meta>+<Alt>+M",shortcut:"Meta+Alt+M",platform:"mac",browser:"all",description:"Minimize (All)",playground:!1},{label:"backspace",shortcut:"backspace",platform:"mac",
browser:"chrome",description:"Goes to the previous page in your browsing history for the tab.",playground:!1},{label:"<Meta>+[",shortcut:"Meta+[",platform:"mac",browser:"chrome",description:"Goes to the previous page in your browsing history for the tab",playground:!1},{label:"<Meta>+]",shortcut:"Meta+]",platform:"mac",browser:"chrome",description:"Goes to the next page in your browsing history for the tab.",playground:!1},{label:"<Meta>+<Shift>+?",shortcut:"Meta+Shift+?",platform:"mac",browser:"chrome",description:"Browser Help",playground:!1},{label:"<Meta>+<Ctrl>+F",shortcut:"Meta+Ctrl+F",platform:"mac",browser:"chrome",
