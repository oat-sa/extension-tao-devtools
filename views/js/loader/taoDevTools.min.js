define("taoDevTools/controller/ControllerMap/index",function(){}),define("taoDevTools/controller/fontConversion/fileUpload",["jquery","uikitLoader","ui/uploader","ui/feedback"],function(container,ui,uploader,feedback){container=container("#upload-container");container.uploader({uploadUrl:container.data("url")}),container.on("upload.uploader",function(e,file,interactionHook){feedback().success(interactionHook.success)}),container.on("fail.uploader",function(e,file,interactionHook){feedback().error(interactionHook.message)})}),define("json!taoDevTools/controller/KeyChecker/shortcuts.json",function(){return[{label:"<Meta>+C",shortcut:"Meta+C",platform:"mac",
browser:"all",description:"Copy to clipboard.",playground:!0},{label:"<Meta>+V",shortcut:"Meta+V",platform:"mac",browser:"all",description:"Paste from clipboard.",playground:!0},{label:"<Meta>+<Alt>+V",shortcut:"Meta+Alt+V",platform:"mac",browser:"all",description:"Paste Style",playground:!0},{label:"<Meta>+<Shift>+<Alt>+V",shortcut:"Meta+Shift+Alt+V",platform:"mac",browser:"all",description:"Paste and Match Style",playground:!0},{label:"<Meta>+X",shortcut:"Meta+X",platform:"mac",browser:"all",description:"Cut to the clipboard",playground:!0},{label:"<Meta>+:",shortcut:"Meta+:",platform:"mac",browser:"all",description:"Show / Hide Spelling and Grammar",
playground:!1},{label:"<Ctrl>+F3",shortcut:"Ctrl+F3",platform:"mac",browser:"all",description:"Opens windows menu / dock.",playground:!1},{label:"<Ctrl>+F2",shortcut:"Ctrl+F2",platform:"mac",browser:"all",description:"Activate Menu",playground:!1},{label:"<Ctrl>+F8",shortcut:"Ctrl+F8",platform:"mac",browser:"all",description:"Active Menu Extras",playground:!1},{label:"<Shift>+<Meta>+Right",shortcut:"Shift+Meta+Right",platform:"mac",browser:"all",description:"Switch Applications",playground:!1},{label:"<Meta>+<Alt>+W",shortcut:"Meta+Alt+W",platform:"mac",browser:"all",description:"Close application",playground:!1},{label:"<Meta>+<Shift>+3",
shortcut:"Meta+Shift+3",platform:"mac",browser:"all",description:"Take screenshot (entire screen)",playground:!1},{label:"<Meta>+<Shift>+4",shortcut:"Meta+Shift+4",platform:"mac",browser:"all",description:"Take screenshot (partial / active window)",playground:!1},{label:"<Meta>+<Shift>+W",shortcut:"Meta+Shift+W",platform:"mac",browser:"all",description:"Closes the current window.",playground:!1},{label:"<Meta>+M",shortcut:"Meta+M",platform:"mac",browser:"all",description:"Minimizes the window.",playground:!1},{label:"<Meta>+<Alt>+M",shortcut:"Meta+Alt+M",platform:"mac",browser:"all",description:"Minimize (All)",playground:!1},{label:"backspace",
shortcut:"backspace",platform:"mac",browser:"chrome",description:"Goes to the previous page in your browsing history for the tab.",playground:!1},{label:"<Meta>+[",shortcut:"Meta+[",platform:"mac",browser:"chrome",description:"Goes to the previous page in your browsing history for the tab",playground:!1},{label:"<Meta>+]",shortcut:"Meta+]",platform:"mac",browser:"chrome",description:"Goes to the next page in your browsing history for the tab.",playground:!1},{label:"<Meta>+<Shift>+?",shortcut:"Meta+Shift+?",platform:"mac",browser:"chrome",description:"Browser Help",playground:!1},{label:"<Meta>+<Ctrl>+F",shortcut:"Meta+Ctrl+F",platform:"mac",
browser:"chrome",description:"Opens or Exits current page in full-screen mode. (TAO will enforce full screen.)",playground:!1},{label:"<Meta>+1",shortcut:"Meta+1",platform:"mac",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+2",shortcut:"Meta+2",platform:"mac",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+3",shortcut:"Meta+3",platform:"mac",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+4",
shortcut:"Meta+4",platform:"mac",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+5",shortcut:"Meta+5",platform:"mac",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+6",shortcut:"Meta+6",platform:"mac",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+7",shortcut:"Meta+7",platform:"mac",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{
label:"<Meta>+8",shortcut:"Meta+8",platform:"mac",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+9",shortcut:"Meta+9",platform:"mac",browser:"chrome",description:"Switches to the last tab.",playground:!1},{label:"<Meta>+D",shortcut:"Meta+D",platform:"mac",browser:"chrome",description:"Saves your current webpage as a bookmark.",playground:!1},{label:"<Meta>+F",shortcut:"Meta+F",platform:"mac",browser:"chrome",description:"Opens the find bar.",playground:!1},{label:"<Meta>+G",shortcut:"Meta+G",platform:"mac",browser:"chrome",
description:"Finds the next match for your input in the find bar.",playground:!1},{label:"<Meta>+Y",shortcut:"Meta+Y",platform:"mac",browser:"chrome",description:"Opens the History page.",playground:!1},{label:"<Meta>+<Shift>+J",shortcut:"Meta+Shift+J",platform:"mac",browser:"chrome",description:"Opens the Downloads page.",playground:!1},{label:"<Meta>+L",shortcut:"Meta+L",platform:"mac",browser:"chrome",description:"Highlights the URL. (Appears not to work in Full Screen Mode)",playground:!0},{label:"<Meta>+N",shortcut:"Meta+N",platform:"mac",browser:"chrome",description:"Opens a new window.",playground:!1},{label:"<Meta>+O",shortcut:"Meta+O",
platform:"mac",browser:"chrome",description:"Opens a file from your computer in Google Chrome.",playground:!1},{label:"<Meta>+P",shortcut:"Meta+P",platform:"mac",browser:"chrome",description:"Prints your current page.",playground:!1},{label:"<Meta>+Q",shortcut:"Meta+Q",platform:"mac",browser:"chrome",description:"Quits Google Chrome.",playground:!1},{label:"<Meta>+R",shortcut:"Meta+R",platform:"mac",browser:"chrome",description:"Reloads your current page.",playground:!1},{label:"<Meta>+S",shortcut:"Meta+S",platform:"mac",browser:"chrome",description:"Saves your current page.",playground:!1},{label:"<Meta>+T",shortcut:"Meta+T",platform:"mac",browser:"chrome",
description:"Opens a new tab.",playground:!1},{label:"<Meta>+<Alt>+U",shortcut:"Meta+Alt+U",platform:"mac",browser:"chrome",description:"Opens the source of your current page.",playground:!1},{label:"<Meta>+W",shortcut:"Meta+W",platform:"mac",browser:"chrome",description:"Closes the current tab or pop-up.",playground:!1},{label:"<Meta>+<Shift>+B",shortcut:"Meta+Shift+B",platform:"mac",browser:"chrome",description:"Toggles the bookmarks bar on and off.  (Appears not to work in Full Screen Mode)",playground:!1},{label:"<Meta>+<Alt>+C",shortcut:"Meta+Alt+C",platform:"mac",browser:"chrome",description:"Open / switch from inspect element mode and browser window",
playground:!1},{label:"<Meta>+<Shift>+D",shortcut:"Meta+Shift+D",platform:"mac",browser:"chrome",description:"Saves all open pages as bookmarks in a new folder.",playground:!1},{label:"<Meta>+<Shift>+G",shortcut:"Meta+Shift+G",platform:"mac",browser:"chrome",description:"Finds the previous match for your input in the find bar.",playground:!1},{label:"<Meta>+<Alt>+I",shortcut:"Meta+Alt+I",platform:"mac",browser:"chrome",description:"Opens Developer Tools.",playground:!1},{label:"<Meta>+<Alt>+J",shortcut:"Meta+Alt+J",platform:"mac",browser:"chrome",description:"Open Developer Tools and bring focus to the console",playground:!1},{label:"<Meta>+<Shift>+M",
shortcut:"Meta+Shift+M",platform:"mac",browser:"chrome",description:"Switch between multiple users.",playground:!1},{label:"<Meta>+<Shift>+N",shortcut:"Meta+Shift+N",platform:"mac",browser:"chrome",description:"Opens a new window in incognito mode.",playground:!1},{label:"<Meta>+<Alt>+B",shortcut:"Meta+Alt+B",platform:"mac",browser:"chrome",description:"Opens the bookmark manager.",playground:!1},{label:"<Meta>+<Shift>+T",shortcut:"Meta+Shift+T",platform:"mac",browser:"chrome",description:"Reopens the last tab you've closed.",playground:!1},{label:"<Meta>+<Shift>+W",shortcut:"Meta+Shift+W",platform:"mac",browser:"chrome",description:"Close Window",
playground:!1},{label:"<Meta>+H",shortcut:"Meta+H",platform:"mac",browser:"chrome",description:"Hides Google Chrome.",playground:!1},{label:"<Meta>+<Alt>+H",shortcut:"Meta+Alt+H",platform:"mac",browser:"chrome",description:"Hides all other windows.",playground:!1},{label:"<Meta>+<Shift>+H",shortcut:"Meta+Shift+H",platform:"mac",browser:"chrome",description:"Opens your home page in your current tab.",playground:!1},{label:"<Meta>+<Shift>+I",shortcut:"Meta+Shift+I",platform:"mac",browser:"chrome",description:"Emails your current page.",playground:!1},{label:"<Meta>+<Shift>+P",shortcut:"Meta+Shift+P",platform:"mac",browser:"chrome",
description:"Opens the Page Setup dialog.",playground:!1},{label:"<Meta>+,",shortcut:"Meta+,",platform:"mac",browser:"chrome",description:"Opens the Settings page.",playground:!1},{label:"<Meta>+E",shortcut:"Meta+E",platform:"mac",browser:"chrome",description:"Uses selection for find",playground:!1},{label:"<Alt>+F4",shortcut:"Alt+F4",platform:"mac",browser:"chrome",description:"Close Window",playground:!1},{label:"<Meta>+<Shift>+Delete",shortcut:"Meta+Shift+Delete",platform:"mac",browser:"chrome",description:"Opens the Clear Browsing Data dialog.",playground:!1},{label:"<Meta>+<Alt>+Right",shortcut:"Meta+Alt+Right",platform:"mac",browser:"chrome",
description:"Switches to the next tab.",playground:!1},{label:"<Meta>+<Alt>+Left",shortcut:"Meta+Alt+Left",platform:"mac",browser:"chrome",description:"Switches to the previous tab.",playground:!1},{label:"<Ctrl>+pagedown",shortcut:"Ctrl+pagedown",platform:"mac",browser:"chrome",description:"Switches to the next tab.",playground:!1},{label:"<Ctrl>+pageup",shortcut:"Ctrl+pageup",platform:"mac",browser:"chrome",description:"Switches to the previous tab.",playground:!1},{label:"<Alt>+home",shortcut:"Alt+home",platform:"mac",browser:"chrome",description:"Open Home Page",playground:!1},{label:"<Meta>+LeftMouseClick",shortcut:"Meta+LeftMouseClick",platform:"mac",
browser:"chrome",description:"Opens the link in a new tab in the background.",playground:!0},{label:"<Meta>+<Shift>+LeftMouseClick",shortcut:"Meta+Shift+LeftMouseClick",platform:"mac",browser:"chrome",description:"Opens the link in a new tab in the background.",playground:!0},{label:"<Shift>+LeftMouseClick",shortcut:"Shift+LeftMouseClick",platform:"mac",browser:"chrome",description:"Opens the link in a new window.",playground:!0},{label:"Right Click",shortcut:"Right Click",platform:"mac",browser:"chrome",description:"Context Menu",playground:!1},{label:"<Alt>+LeftMouseClick",shortcut:"Alt+LeftMouseClick",platform:"mac",browser:"chrome",
description:"Downloads the target of the link.",playground:!0},{label:"esc",shortcut:"esc",platform:"mac",browser:"firefox",description:"Stop Loading",playground:!1},{label:"<Meta>+.",shortcut:"Meta+.",platform:"mac",browser:"firefox",description:"Stop Loading",playground:!1},{label:"F5",shortcut:"F5",platform:"mac",browser:"firefox",description:"Reloads your current page.",playground:!1},{label:"<Meta>+1",shortcut:"Meta+1",platform:"mac",browser:"firefox",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+2",shortcut:"Meta+2",platform:"mac",browser:"firefox",
description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+3",shortcut:"Meta+3",platform:"mac",browser:"firefox",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+4",shortcut:"Meta+4",platform:"mac",browser:"firefox",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+5",shortcut:"Meta+5",platform:"mac",browser:"firefox",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+6",shortcut:"Meta+6",platform:"mac",
browser:"firefox",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+7",shortcut:"Meta+7",platform:"mac",browser:"firefox",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+8",shortcut:"Meta+8",platform:"mac",browser:"firefox",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Meta>+9",shortcut:"Meta+9",platform:"mac",browser:"firefox",description:"Switches to the last tab.",playground:!1},{label:"<Meta>+B",shortcut:"Meta+B",platform:"mac",browser:"firefox",
description:"Bookmarks Sidebar (toggle)",playground:!1},{label:"<Meta>+D",shortcut:"Meta+D",platform:"mac",browser:"firefox",description:"Add bookmark",playground:!1},{label:"<Meta>+F",shortcut:"Meta+F",platform:"mac",browser:"firefox",description:"Find in This Page",playground:!1},{label:"<Meta>+G",shortcut:"Meta+G",platform:"mac",browser:"firefox",description:"Find Again",playground:!1},{label:"<Meta>+<Shift>+H",shortcut:"Meta+Shift+H",platform:"mac",browser:"firefox",description:"Browsing History (toggle)",playground:!1},{label:"<Meta>+J",shortcut:"Meta+J",platform:"mac",browser:"firefox",description:"Download History",playground:!1},{label:"<Meta>+K",
shortcut:"Meta+K",platform:"mac",browser:"firefox",description:"Select Search Bar",playground:!1},{label:"<Meta>+L",shortcut:"Meta+L",platform:"mac",browser:"firefox",description:"Select Location Bar",playground:!1},{label:"<Meta>+N",shortcut:"Meta+N",platform:"mac",browser:"firefox",description:"Open new window.",playground:!1},{label:"<Meta>+O",shortcut:"Meta+O",platform:"mac",browser:"firefox",description:"Open File",playground:!1},{label:"<Meta>+P",shortcut:"Meta+P",platform:"mac",browser:"firefox",description:"Prints your current page.",playground:!1},{label:"<Meta>+R",shortcut:"Meta+R",platform:"mac",browser:"firefox",
description:"Reloads your current page.",playground:!1},{label:"<Meta>+S",shortcut:"Meta+S",platform:"mac",browser:"firefox",description:"Save Page As",playground:!1},{label:"<Meta>+T",shortcut:"Meta+T",platform:"mac",browser:"firefox",description:"Open new tab.",playground:!1},{label:"<Meta>+U",shortcut:"Meta+U",platform:"mac",browser:"firefox",description:"Page Source",playground:!1},{label:"<Meta>+W",shortcut:"Meta+W",platform:"mac",browser:"firefox",description:"Close Tab (close Window if only one tab)",playground:!1},{label:"<Meta>+<Shift>+G",shortcut:"Meta+Shift+G",platform:"mac",browser:"firefox",description:"Find Previous",playground:!1},{
label:"<Meta>+<Shift>+R",shortcut:"Meta+Shift+R",platform:"mac",browser:"firefox",description:"Force Reload Page (override cache)",playground:!1},{label:"<Alt>+F4",shortcut:"Alt+F4",platform:"mac",browser:"firefox",description:"Close Window",playground:!1},{label:"<Alt>+return",shortcut:"Alt+return",platform:"mac",browser:"firefox",description:"Save Link Target As",playground:!0},{label:"<Alt>+home",shortcut:"Alt+home",platform:"mac",browser:"firefox",description:"Open Home Page",playground:!1},{label:"<Meta>+Left",shortcut:"Meta+Left",platform:"mac",browser:"firefox",description:"Back one Page",playground:!1},{label:"<Meta>+Right",shortcut:"Meta+Right",
platform:"mac",browser:"firefox",description:"Forward one Page",playground:!1},{label:"<Meta>+[",shortcut:"Meta+[",platform:"mac",browser:"firefox",description:"Back one Page",playground:!1},{label:"<Meta>+]",shortcut:"Meta+]",platform:"mac",browser:"firefox",description:"Forward one Page",playground:!1},{label:"<Meta>+return",shortcut:"Meta+return",platform:"mac",browser:"firefox",description:"Open Link (in new Background Tab)",playground:!0},{label:"<Meta>+F4",shortcut:"Meta+F4",platform:"mac",browser:"firefox",description:"Closes the current tab or pop-up.",playground:!1},{label:"<Meta>+F5",shortcut:"Meta+F5",platform:"mac",browser:"firefox",
description:"Force Reload Page (override cache)",playground:!1},{label:"<Meta>+<Shift>+T",shortcut:"Meta+Shift+T",platform:"mac",browser:"firefox",description:"Undo Close Tab",playground:!1},{label:"<Ctrl>+tab",shortcut:"Ctrl+tab",platform:"mac",browser:"firefox",description:"Next Tab",playground:!1},{label:"<Ctrl>+pagedown",shortcut:"Ctrl+pagedown",platform:"mac",browser:"firefox",description:"Switches to the next tab.",playground:!1},{label:"<Ctrl>+pageup",shortcut:"Ctrl+pageup",platform:"mac",browser:"firefox",description:"Switches to the previous tab.",playground:!1},{label:"<Meta>+<Shift>+W",shortcut:"Meta+Shift+W",platform:"mac",browser:"firefox",
description:"Close Window",playground:!1},{label:"<Shift>+F3",shortcut:"Shift+F3",platform:"mac",browser:"firefox",description:"Find Previous",playground:!1},{label:"<Shift>+return",shortcut:"Shift+return",platform:"mac",browser:"firefox",description:"Open Link in New Window",playground:!0},{label:"Right Click",shortcut:"Right Click",platform:"mac",browser:"firefox",description:"Context Menu",playground:!1},{label:"<Meta>+<Shift>+LeftMouseClick",shortcut:"Meta+Shift+LeftMouseClick",platform:"mac",browser:"firefox",description:"Open Link (in new Foreground Tab)",playground:!0},{label:"<Meta>+LeftMouseClick",shortcut:"Meta+LeftMouseClick",platform:"mac",
browser:"firefox",description:"Open Link (in new Background Tab)",playground:!0},{label:"<Shift>+LeftMouseClick",shortcut:"Shift+LeftMouseClick",platform:"mac",browser:"firefox",description:"Open Link in New Window",playground:!0},{label:"/",shortcut:"/",platform:"mac",browser:"firefox",description:"Quick Find Text (not critical)",playground:!1},{label:"",shortcut:"",platform:"mac",browser:"firefox",description:"Quick Find Link (not critical)",playground:!0},{label:"<Ctrl>+c",shortcut:"Ctrl+c",platform:"win",browser:"all",description:"Copy to clipboard.",playground:!0},{label:"<Ctrl>+v",shortcut:"Ctrl+v",platform:"win",browser:"all",
description:"Paste from clipboard.",playground:!0},{label:"<Ctrl>+x",shortcut:"Ctrl+x",platform:"win",browser:"all",description:"Cut to the clipboard",playground:!0},{label:"<Ctrl>+esc",shortcut:"Ctrl+esc",platform:"win",browser:"all",description:"Opens windows menu / dock.",playground:!1},{label:"<Ctrl>+F4",shortcut:"Ctrl+F4",platform:"win",browser:"all",description:"Close the active window.",playground:!1},{label:"<Shift>+F6",shortcut:"Shift+F6",platform:"win",browser:"all",description:"Switches focus to the next keyboard-accessible pane. (Doesn't seem to work in fullscreen mode.)",playground:!1},{label:"<Alt>+esc",shortcut:"Alt+esc",platform:"win",
browser:"all",description:"Switch Applications",playground:!1},{label:"<Alt>+tab",shortcut:"Alt+tab",platform:"win",browser:"all",description:"Switch Applications",playground:!1},{label:"<Alt>+space",shortcut:"Alt+space",platform:"win",browser:"all",description:"Open the shortcut menu for the active window",playground:!0},{label:"<Alt>+F4",shortcut:"Alt+F4",platform:"win",browser:"all",description:"Close application",playground:!1},{label:"PrtScn",shortcut:"PrtScn",platform:"win",browser:"all",description:"Take screenshot (entire screen)",playground:!1},{label:"<Alt>+PrtScn",shortcut:"Alt+PrtScn",platform:"win",browser:"all",
description:"Take screenshot (partial / active window)",playground:!1},{label:"<Meta>+D",shortcut:"Meta+D",platform:"win",browser:"all",description:"Minimize (All)",playground:!1},{label:"esc",shortcut:"esc",platform:"win",browser:"chrome",description:"Stops the loading of the current page.",playground:!1},{label:"backspace",shortcut:"backspace",platform:"win",browser:"chrome",description:"Goes to the previous page in your browsing history for the tab.",playground:!1},{label:"Backspace+Left Arrow",shortcut:"Backspace+Left Arrow",platform:"win",browser:"chrome",description:"Goes to the previous page in your browsing history for the tab",playground:!1},{
label:"Backspace+Right Arrow",shortcut:"Backspace+Right Arrow",platform:"win",browser:"chrome",description:"Goes to the next page in your browsing history for the tab.",playground:!1},{label:"F1",shortcut:"F1",platform:"win",browser:"chrome",description:"Browser Help",playground:!1},{label:"F3",shortcut:"F3",platform:"win",browser:"chrome",description:"Finds the next match for your input in the find bar.",playground:!1},{label:"F5",shortcut:"F5",platform:"win",browser:"chrome",description:"Reloads your current page.",playground:!1},{label:"F6",shortcut:"F6",platform:"win",browser:"chrome",description:"Switches focus to the next keyboard-accessible pane.",
playground:!1},{label:"F10",shortcut:"F10",platform:"win",browser:"chrome",description:"Opens the Chrome menu Chrome menu",playground:!1},{label:"F11",shortcut:"F11",platform:"win",browser:"chrome",description:"Opens or Exits current page in full-screen mode. (TAO will enforce full screen.)",playground:!1},{label:"F12",shortcut:"F12",platform:"win",browser:"chrome",description:"Opens Developer Tools.",playground:!1},{label:"<Ctrl>+1",shortcut:"Ctrl+1",platform:"win",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Ctrl>+2",shortcut:"Ctrl+2",platform:"win",browser:"chrome",
description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Ctrl>+3",shortcut:"Ctrl+3",platform:"win",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Ctrl>+4",shortcut:"Ctrl+4",platform:"win",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Ctrl>+5",shortcut:"Ctrl+5",platform:"win",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Ctrl>+6",shortcut:"Ctrl+6",platform:"win",
browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Ctrl>+7",shortcut:"Ctrl+7",platform:"win",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Ctrl>+8",shortcut:"Ctrl+8",platform:"win",browser:"chrome",description:"Switches to the tab at the specified position number on the tab strip.",playground:!1},{label:"<Ctrl>+9",shortcut:"Ctrl+9",platform:"win",browser:"chrome",description:"Switches to the last tab.",playground:!1},{label:"<Ctrl>+d",shortcut:"Ctrl+d",platform:"win",browser:"chrome",
...
platform:navigator.platform,browser:navigator.userAgent,browserType:browserType,shortcuts:shortcutsResults},actions={showShortcuts:function(){displaySection("shortcuts")},showResults:function(){displaySection("results")},selectResults:function(){var element,range;element=$container.find(".results pre").get(0),document.selection?((range=document.body.createTextRange()).moveToElementText(element),range.select()):window.getSelection&&((range=document.createRange()).selectNode(element),window.getSelection().addRange(range));try{document.execCommand("copy")}catch(err){alert("Oops, unable to copy")}},resetAll:function(){shortcutHelper.clear(),current=-1,
currentShortcut=null,shortcutsResults=[],setResults(),actions.nextShortcut()},previousShortcut:function(){removeShortcut(),function(){currentShortcut=null;for(;!currentShortcut;)if((currentShortcut=listOfKeys[--current])&&(currentShortcut.platform&&"all"!==currentShortcut.platform&&currentShortcut.platform.indexOf(platformType)<0||currentShortcut.browser&&"all"!==currentShortcut.browser&&currentShortcut.browser.indexOf(browserType)<0)&&(currentShortcut=null),current<0){current=0,currentShortcut=null;break}}(),updateKeyChecker()},nextShortcut:function(){removeShortcut(),!function(){currentShortcut=null;for(;!currentShortcut;)if((
currentShortcut=listOfKeys[++current])&&(currentShortcut.platform&&"all"!==currentShortcut.platform&&currentShortcut.platform.indexOf(platformType)<0||currentShortcut.browser&&"all"!==currentShortcut.browser&&currentShortcut.browser.indexOf(browserType)<0)&&(currentShortcut=null),current>=listOfKeys.length){currentShortcut=null;break}return currentShortcut}()?(hider.hide($container.find(".desk")),hider.show($container.find(".end")),actions.showResults()):updateKeyChecker()}};function setResults(){function done(){resultData.shortcuts=_.compact(shortcutsResults),$container.find(".results pre").html(JSON.stringify(resultData,null,2))}keycheckStorage.setItem(
"state",{current:current,results:shortcutsResults}).then(done).catch(done)}function updateCurrentResult(){var defaultPrevented=$container.find('input[name="default_prevented"][value="1"]').is(":checked"),comment=$container.find(".comment textarea").val();currentShortcut&&(shortcutsResults[current]={shortcut:formatShortcut(currentShortcut.label),shortcutCaught:shortcutCaught,defaultPrevented:defaultPrevented},$container.find('.prevented label[for="default_prevented_yes"]').css("color",defaultPrevented?"green":null),$container.find('.prevented label[for="default_prevented_no"]').css("color",defaultPrevented?null:"red"),
...
StudentTollGenerator:{actions:{index:"controller/fontConversion/fileUpload"}},KeyChecker:{actions:{index:"controller/KeyChecker/index"}}}}),define("taoDevTools/controller/ScriptRunner/index",["jquery","helpers","ui/feedback"],function($,helpers,feedback){return{start:function(){$(".script").click(function(action){action=$(action.target).data("action");$.ajax({type:"POST",url:helpers._url(action,"ScriptRunner","taoDevTools"),dataType:"json",success:function(data){helpers.loaded(),data.success?feedback().success(data.message):feedback().error(data.message)}})})}}}),define("taoDevTools/controller/settings/extensionManager",["jquery","i18n","util/url",
